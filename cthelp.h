/* cthelp.h - constant time helper functions
 *
 ...
 */
#ifndef SLIP0039_CTHELP_H
#define SLIP0039_CTHELP_H
#include <stdint.h>
...
// return a == b
static inline int cthelp_eq(uint32_t a, uint32_t b) {
	return 1 - cthelp_neq(a, b);
}

#endif /* SLIP0039_CTHELP_H */
