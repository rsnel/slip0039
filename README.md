...
slip0039(1) uses standard input for input and standard output as output
...
on the commandline the SEED, the iteration EXPonent and the specifications of
...
XofY reflects the distribution of shares in the first group
UofV reflects the distribution of shares in the second group
etc
